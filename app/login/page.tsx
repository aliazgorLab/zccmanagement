...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f5f6f8] px-6 py-16 sm:px-10">
      <div
        className="pointer-events-none absolute -left-36 -top-24 h-80 w-80 rounded-full bg-[#9bc4ff]/25 blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-[#ffd8b2]/25 blur-3xl"
        aria-hidden
      />
